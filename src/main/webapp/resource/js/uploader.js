...
$().ready(function() {
	$('#oldImage').css('max-height', thumbnailHeight+"px");
	$('#oldImage').css('max-width', thumbnailWidth+"px");
    ...
    uploader.on( 'uploadAccept', function( object,data  ) {
    	doAfterUploadAccept(object,data);
    });
    uploader.on( 'uploadBeforeSend', function( object,data  ) {
    	doUploadBeforeSend(object,data);
    });
